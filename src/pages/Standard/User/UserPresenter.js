    ...
    <div className="user-content">
      ...
      >
        ...
        >
          ...
          <Form.Item label="비밀번호" name="userPw">
            <Input
              type="password"
          ...
          <Form.Item label="전화번호" name="userPhone">
            <Input
          ...
          <Form.Item label="업무" name="userWork">
            <Input
          ...
          <Form.Item label="급여" name="userSalary">
            <Input
          ...
          <Form.Item label="직급" name="role">
            <Select
              ...
              onChange={(value) => HandleChangeSelect("roleNo", value)}
            />
          </Form.Item>
        ...
        >
          ...
          <Form.Item label="급여">
            <Input
              ...
              name="userSalary"
              onChange={HandleUpdateChangeInput}
              value={updateUserInfo.userSalary}
            />
          </Form.Item>
          ...
          <Form.Item label="부서">
            <Select
              ...
              onChange={(value) =>
                HandleUpdateChangeSelect("departmentNo", value)
              }
            />
          </Form.Item>
          <Form.Item label="직급">
