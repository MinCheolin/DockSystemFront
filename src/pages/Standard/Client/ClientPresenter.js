...
const ClientPresenter = ({
  ...
  const typeOptions = [
    { value: "자재", label: "자재" },
    { value: "장비", label: "장비" },
    { value: "도료/코팅", label: "도료/코팅" },
    { value: "설계/엔지니어링", label: "설계/엔지니어링" },
    { value: "검사/인증", label: "검사/인증" },
    { value: "물류/운송", label: "물류/운송" },
    { value: "it소프트웨어", label: "it소프트웨어" },
  ];
  ...
  const typeFilter = [...new Set(clients.map((client) => client.type))].map(
    (type) => ({
      text: type,
      value: type,
    })
  ...
  const ceoFilter = [...new Set(clients.map((client) => client.clientCeo))].map(
    (ceo) => ({
      text: ceo,
      value: ceo,
    })
  ...
  const managerFilter = [
    ...new Set(clients.map((client) => client.clientManager)),
  ].map((manager) => ({
    text: manager,
    value: manager,
  }));
  ...
  const columns = [
    ...
    { title: "사업자 등록 번호", dataIndex: "clientBrn", key: "clientBrn" },
    {
      ...
      key: "clientCeo",
      filters: ceoFilter,
      onFilter: (value, record) => record.clientCeo === value,
    },
    {
      title: "담당자명",
      ...
      onFilter: (value, record) => record.clientManager === value,
    },
          ...
          >
            ...
            <Form.Item label="담당자명">
              <Input
                ...
                name="clientManager"
                value={clientInfo.clientManager}
                onChange={HandleChangeInput}
              />
            </Form.Item>
            <Form.Item label="연락처">
