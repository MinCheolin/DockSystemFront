    ...
    <div className="bom-content" style={{ padding: "24px" }}>
      ...
      >
        ...
        >
          <Form.Item
            label="선박 선택"
            name="vesselNo"
            rules={[{ required: true, message: "선박 선택 필수" }]}
          >
          ...
          <Form.Item
            label="표준 공정 선택"
            name="spNo"
            rules={[{ required: true, message: "공정 선택 필수" }]}
          >
                ...
                {fields.map((field) => (
                  <Space key={field.key} align="baseline">
                    <Form.Item
                      ...
                      rules={[
                        { required: true, message: "자재를 선택하세요." },
                      ]}
                    >
                      <Select
                        options={materials}
      ...
      <Modal
        title={
          <div className="modal-title">
            {isEditing
              ? `BOM 수정 - ${selectedBOM?.bomNo}`
              : `BOM 상세 - ${selectedBOM?.bomNo}`}
          </div>
        }
      ...
      >
        {isEditing ? (
          ...
          >
            <Form.Item label="선박">
              <b>{selectedBOM?.vesselName}</b>
            </Form.Item>
            <Form.Item label="공정">
              <b>{selectedBOM?.spName}</b>
            </Form.Item>
            <p>
              <b>BOM 상세 항목</b>
            </p>
          ...
          selectedBOM && (
            <div>
              <div className="modal-info-box">
                <p>
                  <b>선박 : </b> {selectedBOM.vessel.vesselName}
                </p>
                <p>
                  <b>공정 : </b> {selectedBOM.spName.spName}
                </p>
              </div>
              <Table
                columns={[
                  ...
                  {
                    title: "수량",
                    dataIndex: "bomDetailCount",
                    sorter: (a, b) => a.bomDetailCount - b.bomDetailCount,
                  },
                ]}
